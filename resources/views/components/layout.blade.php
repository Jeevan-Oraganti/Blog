...
<body class="font-sans bg-gray-100 text-gray-900" style="font-family: 'Open Sans', sans-serif">
    ...
    <section class="flex flex-col px-6 py-8 min-h-screen">
        <nav class="md:flex md:justify-between md:items-center bg-gray-900 p-5 shadow-lg rounded-xl fixed top-3 left-2 right-2 z-50">
        ...
        <footer id="newsletter" class="mt-20 relative w-full bg-gray-800 text-white border border-black border-opacity-5 rounded-xl text-center py-8 px-10">
