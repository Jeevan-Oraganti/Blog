                    ...
                    <div id="menu" x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        $navItems = [
                            [
                                ...
                                'url' => '/admin/posts',
                                'is_disabled' => true,
                                'icon_url' => 'fas fa-tachometer-alt',
                                'is_featured' => true,
                            ],
                            [
                                'name' => 'New Post',
                            ...
                            [
                                ...
                                'url' => '#',
                                'is_disabled' => false,
                                'icon_url' => 'fas fa-sign-out-alt',
                                'is_featured' => false,
                                'onclick' => "document.querySelector('#logout-form').submit()",
                            ],
                        ];

                        $linkTemplate = '<a href="%s" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-blue-500 transition duration-150 ease-in-out" %s><i class="%s"></i> %s</a>';
                        $spanTemplate = '<span class="block px-4 py-2 text-sm text-gray-700 cursor-not-allowed"><i class="%s"></i> %s</span>';
                        ?>
